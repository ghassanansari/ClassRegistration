...
<form method="POST" action="sendmessage.php" class="message" style="width: 500px">
  <table>
    <tr>
      <td>To</td>
      <td>
        <input type="text" class="field1 round" name="contact" id="contact" value="<?php echo $sender;?>">
    ...
    <tr>
      <td>Subject</td>
      <td>
        <input type="text" class="field1 round" name="subject" id="subject" value="<?php echo 'RE: '.$subject;?>">
      </td>
    </tr>
