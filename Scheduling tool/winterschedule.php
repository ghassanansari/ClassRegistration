...
error_reporting( 0 );
    ...
    while(conflict == true){
        ...
        $tut =false;
        $lab = false;
        $result = mysqli_query($con,"SELECT * FROM LecturesW WHERE APPEAR = 1 AND CRSE='$NUM[$k]'");
        ...
        $result = mysqli_query($con,"SELECT * FROM LecturesW WHERE id = '$LID'");
        ...
        $result_1 = mysqli_query($con,"SELECT * FROM LabW WHERE LID = '$LID'");    
        ...
        if($lab == true){
            ...
            $result_1 = mysqli_query($con,"SELECT * FROM LabW WHERE ID = '$ID'");
        ...
        //echo "<tr><td>".$id_1."</td><td>".$SUBJ."</td><td>".$CRSE."</td><td>".$SEQ."</td><td>".$INSTR_TYPE."</td><td>".$DAYS."</td><td>".$START_TIME."</td><td>".$END_TIME."</td></tr>";
        ...
        $i=0;
        $result_2 = mysqli_query($con,"SELECT * FROM TutorialW WHERE LID = '$LID'");    
        ...
        if($tut ==true){
            ...
            $result_2 = mysqli_query($con,"SELECT * FROM TutorialW WHERE ID = '$TID'");
